...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-paypal-rest-sdk/node_modules/paypal-rest-sdk/lib/paypal-rest-sdk.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-paypal-rest-sdk/node_modules/paypal-rest-sdk/lib/paypal-rest-sdk.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-paypal-rest-sdk/node_modules/paypal-rest-sdk/lib/</a> &#187; paypal-rest-sdk.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function configure(options) {</span>
<span class="cstat-no" title="statement not covered" >        api.configure(options);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function generateToken(config, cb) {</span>
<span class="cstat-no" title="statement not covered" >        api.generateToken(config, cb);</span>
    }
&nbsp;
    return {
